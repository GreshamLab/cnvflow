...
Run this code on the HPC because very large files.
```{r}
...
###STEP 9: Plot gate-based time series plots
...
###STEP 10: Plot ridgeplots and other non-gate-based time series plots 
