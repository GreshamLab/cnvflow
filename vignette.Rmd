...
A universal? sample sheet is imported to the function. 
This function uses regex to extract column names from the sample sheet
to generate an experiment details file and places it inside each corresponedong subdirecotry. 
```{r}
